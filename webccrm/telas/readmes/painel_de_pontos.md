...
* _Para ser Aplicado o_ `Painel de Pontos` _é necessário ter_ :
  * _Uma `Meta` criada e cadastrada ( Vídeo demonstrando como criar_ ![icon_ytb](https://raw.githubusercontent.com/Makesystem/manuais/main/webccrm/telas/icon_standard/16%20-%20Todas%20telas/youtube.png) [**Link do vídeo**](https://youtu.be/I9LTHVsGVlA?t=23) );
  * _Uma `Configuração` criada e cadastrada ( Vídeo demonstrando como criar_ ![icon_ytb](https://raw.githubusercontent.com/Makesystem/manuais/main/webccrm/telas/icon_standard/16%20-%20Todas%20telas/youtube.png) [**Link do vídeo**](https://youtu.be/S8WrsXjE2uA?t=21) );
...
###### 2.1.1 - ⚠️ clicando nos links à cima, verá os vídeos de como cria-los dentro do sistema.
